...
evteck/board/gpio/%.o evteck/board/gpio/%.su: ../evteck/board/gpio/%.c evteck/board/gpio/subdir.mk
...
clean: clean-evteck-2f-board-2f-gpio

clean-evteck-2f-board-2f-gpio:
	-$(RM) ./evteck/board/gpio/gpio.d ./evteck/board/gpio/gpio.o ./evteck/board/gpio/gpio.su

.PHONY: clean-evteck-2f-board-2f-gpio
